 ...
 * @license MIT
 */
function m(){let o=Object.assign(document.createElement("div"),{className:"alert-toast-stack"}),t=o.attachShadow({mode:"open"}),e=`
    :host {
      display: contents;
...
`,v=document.createElement("template");v.innerHTML=k`
  <style>
    ${T}
  </style>
...
`;var p=class o extends HTMLElement{#i=!1;#t=null;#e=null;#a=null;#n=null;#l;static customAnimations;#o=d;#s=null;#u=null;#m=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(v.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label","announce","countdown"]}attributeChangedCallback(t,e,s){if(!(!this.#i||e===s))switch(t){case"open":this.open?(this.duration!==1/0&&this.#s?.start(),this.#t?.removeAttribute("hidden"),this.#d(g),this.#y(this.#t)?.finished.finally(()=>{this.#d(b)})):(this.duration!==1/0&&this.#s?.reset(),this.#d(w,{reason:this.#o}),this.#_(this.#t)?.finished.finally(()=>{this.#t?.setAttribute("hidden",""),this.#d(c,{reason:this.#o}),this.#o=d}));break;case"duration":this.#s?.stop().off("tick",this.#h).off("finish",this.#c),this.#s=new l({duration:this.duration}).on("tick",this.#h).on("finish",this.#c),this.open&&this.duration!==1/0&&this.#s.start();break;case"close-label":this.#f();break;case"announce":this.announce!=="none"?this.#t?.setAttribute("role",this.announce):this.#t?.removeAttribute("role");break;case"countdown":this.#u?.toggleAttribute("hidden",!this.countdown);break;default:break}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(t===null)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",t!=null?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",t!=null?t.toString():t)}get announce(){let t=this.getAttribute("announce");return t==="alert"||t==="status"||t==="none"?t:"alert"}set announce(t){this.setAttribute("announce",t!=null?t.toString():t)}get countdown(){return this.hasAttribute("countdown")}set countdown(t){this.toggleAttribute("countdown",!!t)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(t){this.toggleAttribute("no-animations",!!t)}get customAnimations(){return this.#l}set customAnimations(t){this.#l=t}connectedCallback(){this.#r("closable"),this.#r("open"),this.#r("duration"),this.#r("variant"),this.#r("closeLabel"),this.#r("announce"),this.#r("countdown"),this.#r("noAnimations"),this.#r("customAnimations"),this.#t=this.shadowRoot?.querySelector(".alert")??null,this.#e=this.shadowRoot?.querySelector(".alert__close")??null,this.#a=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#u=this.shadowRoot?.querySelector(".alert__countdown")??null,this.#m=this.shadowRoot?.querySelector(".alert__countdown-elapsed")??null,this.#e?.addEventListener("click",this.#b),this.#a?.addEventListener("slotchange",this.#g),this.addEventListener("mouseenter",this.#p),this.addEventListener("mouseleave",this.#v),this.addEventListener("command",this.#w),this.#s=new l({duration:this.duration}).on("tick",this.#h).on("finish",this.#c),this.open?(this.duration!==1/0&&this.#s?.start(),this.#t?.removeAttribute("hidden")):this.#t?.setAttribute("hidden",""),this.closeLabel&&this.#f(),this.announce!=="none"?this.#t?.setAttribute("role",this.announce):this.#t?.removeAttribute("role"),this.#u?.toggleAttribute("hidden",!this.countdown),this.#i=!0}disconnectedCallback(){this.#i=!1,this.#s?.stop().off("tick",this.#h).off("finish",this.#c),this.#s=null,this.#e?.removeEventListener("click",this.#b),this.#a?.removeEventListener("slotchange",this.#g),this.removeEventListener("mouseenter",this.#p),this.removeEventListener("mouseleave",this.#v),this.removeEventListener("command",this.#w)}connectedMoveCallback(){}#h=t=>{if(!this.countdown||!this.#m)return;let{remaining:e}=t.currentTarget;this.#m.style.width=`${e/this.duration*100}%`};#c=()=>{this.#o=_,this.open=!1};#b=()=>{this.closable&&(this.#o=y,this.open=!1)};#p=()=>{this.open&&this.duration!==1/0&&this.#s?.stop()};#v=()=>{this.open&&this.duration!==1/0&&this.#s?.start()};#g=()=>{this.#f()};#w=t=>{switch(t.command){case E:this.open=!0;break;case A:this.#o=d,this.open=!1;break;default:break}};#f(){if(!this.#e)return;(this.#a?.assignedElements()||[])?.some(s=>s.textContent?.replace(/\s/g,"")!=="")?this.#e.removeAttribute("aria-label"):this.#e.setAttribute("aria-label",this.closeLabel)}#E(){let t=window.matchMedia("(prefers-reduced-motion: reduce)").matches,e={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},s=this.customAnimations||o.customAnimations||{},i=t||this.noAnimations||this.customAnimations===null||o.customAnimations===null,n=a=>{let h=s[a]?.options??{},u=e[a].options;return{...u,...h,duration:i?0:h.duration??u.duration}};return{show:{keyframes:s.show?.keyframes??e.show.keyframes,options:n("show")},hide:{keyframes:s.hide?.keyframes??e.hide.keyframes,options:n("hide")}}}#y(t){let{keyframes:e,options:s}=this.#E().show;return t?.animate(e,s)}#_(t){let{keyframes:e,options:s}=this.#E().hide;return t?.animate(e,s)}#d(t,e=null){let s={bubbles:!0,composed:!0,detail:e},i=new CustomEvent(t,s);this.dispatchEvent(i)}#A(t,e){return new Promise(s=>{let i=n=>{n.target===t&&s()};t.addEventListener(e,i,{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#A(this,b))}hide(){return this.open?(this.open=!1,this.#A(this,c)):Promise.resolve()}toast(t={}){if(t={...{forceRestart:!1},...t},this.#n){if(!t.forceRestart)return this.#n.promise;this.#n.resolve(),this.#n.cleanup()}let s=()=>{},i=new Promise(h=>s=h),n=()=>{this.#n?.resolve(),this.#n?.cleanup()};this.#n={promise:i,resolve:s,cleanup:()=>{this.removeEventListener(c,n),this.parentNode===r&&r.removeChild(this),r.querySelector(f)||r.remove(),this.open=!1,this.#n=null}},r.parentElement||document.body.append(r),r.appendChild(this),this.#t?.setAttribute("data-toast",""),this.open=!0;let a=r.shadowRoot?.querySelector(".stack");return a?.scrollTo({top:a.scrollHeight}),this.addEventListener(c,n,{once:!0}),i}#r(t){let e=this;if(Object.prototype.hasOwnProperty.call(e,t)){let s=e[t];delete e[t],e[t]=s}}static defineCustomElement(t=f){typeof window<"u"&&!window.customElements.get(t)&&window.customElements.define(t,o)}};export{p as AlertElement,d as CLOSE_REASON_API,_ as CLOSE_REASON_TIMEOUT,y as CLOSE_REASON_USER,A as COMMAND_ALERT_HIDE,E as COMMAND_ALERT_SHOW,c as EVENT_ALERT_AFTER_HIDE,b as EVENT_ALERT_AFTER_SHOW,w as EVENT_ALERT_HIDE,g as EVENT_ALERT_SHOW};
